      ...
      <v-col cols="8" sm="6" class="pt-10 text-left">
        ...
        >
          <v-card>
            ...
            <v-card-text>
              <vue-croppie ref="croppieRef" :showZoomer="true" :enableOrientation="false" :enableResize="false" :enforceBoundary="false" :boundary="{ width: 600, height: 350}" :viewport="{ width:450, height:120, 'type':'square' }">
              </vue-croppie>
            </v-card-text>
