        ...
        <v-col cols="12" md="9">
            ...
            <v-form>
                ...
                <div class="create-bid text-left mt-10 pa-4">
                    ...
                    <p class="font-weight-medium">Respond to bid invitations & showcase your services to oil and gas
                        operators to gain access to <br>greater visibility.</p>
                    ...
                    <v-row class="mt-1">
                        <v-col cols="12" sm="12" v-show="trial_end == 'premium'">
                            <label class="d-block text-left input-label mb-2 font-weight-bold">Sales Contacts</label>
                    ...
                    <v-row v-if="trial_end == 'premium'">
                        <v-col cols="12" sm="4" text="left">
                            <v-btn color="#0D9647" large dense width="260px" height="56"
                                ...
                                :loading="loading">Execute Agreement Now <v-icon class="pl-2"
                    ...
                    <v-row v-else>
                        <v-col cols="12" sm="4" text="left">
                            <v-btn color="#0D9647" large dense width="260px" height="56"
                                ...
                                @click="createStandard('ofs')">Confirm Account <v-icon class="pl-2"
                                    color="#fff">mdi-arrow-right-circle</v-icon></v-btn>
                        </v-col>
                    </v-row>
                </div>
                <v-row justify="center" class="mt-10">
                    <v-col cols="12" md="3">
                        <v-btn color="#0D9647" large dense width="100%" height="56"
                            ...
                            :disabled="!contractData ? true : false">Next <v-icon class="pl-2"
                                color="#fff">mdi-arrow-right-circle</v-icon></v-btn>
                    </v-col>
                </v-row>
            </v-form>
...
export default {
    ...
    data() {
        return {
            ...
            packageType: 1,
            packages: [
                { name: '1-5 Staff Members - $79.99/month or $800/year', id: 1 },
                { name: '6-10 Staff Members - $99.99/month or $1,000/year', id: 2 },
                { name: '11-15 Staff Members - $119.99/month or $1,200/year', id: 3 },
                { name: '16+ Staff Members - $239.99/month or $2,400/year', id: 4 },
            ],
        };
    },
    computed: {
