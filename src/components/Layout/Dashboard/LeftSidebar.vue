<template>
  <div class="leftSide-module">
    <div class="desktop-view">
      <v-list nav dense class="pa-0 main-menu" href="">
        <v-list-item-group color="primary">
          <v-list-item
            v-for="(item, i) in items"
            :key="i"
            @click="redirectLink(item)"
          >
            ...
            <v-list-item-content class="text-left py-1">
              ...
              <span
                class="badge"
                :class="[showSideBar ? 'msg-badge' : 'mobile-badge']"
                v-if="i == 3 && showMsgCount > 0"
                >{{ showMsgCount }}</span
              >
            </v-list-item-content>
          </v-list-item>
      ...
      <div class="sidebar-bottomMenu">
                  ...
                  >
                    ...
                    >
                      <v-list-item-title class="font-weight-bold"
                        >Manage Company Profile</v-list-item-title
                      >
                    </router-link>
                  </v-list-item-content>
                </template>
        ...
        <v-list nav dense class="pa-0">
          <v-list-item-group color="primary" class="px-0">
    ...
    checkIfCompanyOfs() {
      if (
        ...
        return this.$store.getters.userInfo.company.contracts.find(
          (contract) =>
            contract.contractType === "ofs" ||
            contract.contractType === "ofs-premium"
        );
      }
      return false;
    },
