...
<script>
  ...
  import ServiceLocations from './CompanyProfile/ServiceLocations.vue'
  import CorporateNews from './CompanyProfile/CorporateNews.vue'
  import CompanyDocuments from './CompanyProfile/CompanyDocuments.vue'
  import CompanyVideos from './CompanyProfile/CompanyVideos.vue'
  import CompanyLogo from './CompanyProfile/CompanyLogo.vue'
