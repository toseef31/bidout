<template>
  <v-col
    class="createBid-module bids-module pa-0 pa-sm-3 pl-sm-0 pb-sm-0"
    :class="[
  ...
  >
    <div class="mid-content">
      <div class="content-section fill-height">
        <div
          class="title-block d-block d-sm-flex justify-space-between pa-4 pa-sm-6 align-center"
        >
          <div>
            <h3 class="font-weight-bold text-left mb-4 mb-sm-0">
              All Bids <font color="#B8B8B8">(6)</font>
            </h3>
          </div>
          <div class="d-block d-sm-flex align-center">
            ...
            >
              ...
              <v-tab
                class="text-capitalize font-weight-bold mr-8"
...
export default {
  ...
  data() {
    return {
      ...
      tab: "tab-0",
      searchBid: "",
      items: ["Open Bids (6)", "Close Bids (3)"],
