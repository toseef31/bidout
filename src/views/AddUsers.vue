              ...
              <div class="manage-sections pa-4 pa-sm-16">
                ...
                <div class="addUser-form mt-16">
                  <v-form ref="form" v-model="valid" lazy-validation>
                    ...
                    <v-select v-model="select" :items="items" :rules="[v => !!v || 'Privileges is required']"
                      placeholder="Select" item-text="label" item-value="value" required outlined solo-flat
                      class="text-capitalize"></v-select>

                    <v-btn :disabled="!valid" color="#0D9648" class="mr-4 text-capitalize white--text font-weight-bold"
                      @click="validate" large height="50px" min-width="220px">
                      Invite User
                    </v-btn>
                  </v-form>
                </div>
