              ...
              <v-row class="mx-0">
                <v-col cols="12" sm="12" md="12" class="d-sm-block">
                  <div class="manage-sections pa-4">
                    <v-alert type="success" v-if="message != null">
                      {{ message }}
                    </v-alert>
                    <div class="top-section d-flex">
                      <h4>Manage Users</h4>
                      <div>
                        <router-link to="" class="pr-8 font-weight-bold">Show Disable Users</router-link>
                        ...
                        <template v-slot:default>
                          ...
                          <tbody>
                            ...
                            >
                              ...
                              <td class="text-left font-weight-medium">{{user.role}}</td>
                              <td class="text-left">
