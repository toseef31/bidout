<template>
  <section class="fill-height getstarted-module white">
          ...
          <v-row justify="center">
            <v-col cols="12" md="9">
              <div class="alert-section">
                ...
                <p>A notification has been sent to the Administrator on the account to approve your access request. For immediate assistence, please reach out your team members at <strong>{{companyName}}</strong> which include: <strong v-for="(admins,index) in companyAdmins">{{admins.firstName}} {{admins.lastName}}<span v-if="index < companyAdmins.length - 1">, </span></strong>.</p>
          ...
          <v-row justify="center">
            <v-col cols="12" md="8">
              <div class="getStart-box pa-6 text-left">
                <h1 class="mb-3 font-weight-bold">For Immediate assistance!</h1>
                <div class="d-flex align-start">
                  <v-icon class="pr-4 mt-1" color="#0D9647">mdi-phone-outline</v-icon>
                  <p>Contact BidOut's support team at <br><strong>832-786-2400</strong></p>
                </div>
              </div>
            </v-col>
          </v-row>
