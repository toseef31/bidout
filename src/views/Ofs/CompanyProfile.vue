      ...
      <v-container fill-height class="pl-0">
        ...
        >
          <v-col
            ...
            cols="3"
          >
            <v-img :src="require('@/assets/images/ofs/company/patterson.png')"></v-img>
          </v-col>
        </v-row>
      </v-container>
    </div>
            ...
            <v-col cols="12" md="9">
              <div class="company-content text-left">
                <div class="company-title mb-12">
                  <h1>Patterson-UTI &nbsp; &nbsp; <span><v-icon color="#0D9647">mdi-check-decagram</v-icon>Premium Service Provider</span></h1>
                </div>
