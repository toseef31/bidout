          ...
          <v-container fill-height class="pl-0">
            ...
            >
              ...
              >
                ...
                <h4 class="pl-3 mt-2"><span v-if="supplierData.isPremium"><span v-if="supplierData.isPremium == 1"></span><v-icon color="#0D9647">mdi-check-decagram</v-icon>Premium Service Provider</span></h4>
              </v-col>
              <v-col
                class="text-left"
                cols="12" sm="8"
            ...
            <v-main class="mb-16 pt-0">
              <v-row justify="center">
                <v-col cols="12" md="9">
                  ...
                  <template v-if="supplierData.isPremium || supplierData.isPremium == 1">
              ...
              <v-col cols="12" md="3" class="pl-0">
                <aside class="company-leftSidebar">
                  ...
                  <div class="tag-box pa-3 d-flex align-center" v-if="!supplierData.isPremium">
