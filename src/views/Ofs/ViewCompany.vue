            ...
            <v-col cols="12" md="3" class="pl-0">
              <aside class="company-leftSidebar">
                <div class="company-logo">
                  ...
                  <h4 class="mb-3"><span v-if="companyInfo.isOfsPremium || companyInfo.isOfsPremium == 'true'"><v-icon color="#0D9647">mdi-check-decagram</v-icon>Premium Service Provider</span></h4>
                </div>
                <div>
                ...
                <div class="tag-box pa-3 d-flex align-center" v-if="!companyInfo.isOfsPremium || companyInfo.isOfsPremium == 'false'">
