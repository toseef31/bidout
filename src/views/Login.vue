    ...
    <v-row class="signin">
      <v-col cols="12" md="6" class="left">
        <div class="form-section mb-15">
          <div
            class="logo mb-lg-15"
            :class="[passwordError != null ? 'mb-0' : 'mb-9']"
          >
            <router-link to="/"
          ...
          <v-alert type="error" v-if="passwordError != null">
            Oops! You have entered a incorrect password, try again, if you are
            still unsure of your password, please
            <router-link to="/forgot-password" class="white--text"
          ...
          >
            ...
            <v-text-field
              ...
              :rules="passwordRules"
              :append-icon="
                showPass ? 'mdi-eye view-pass' : 'mdi-eye-off view-pass'
              "
            ...
            <v-hover v-slot="{ hover }" open-delay="200">
              <router-link to="/forgot-password" class="ml-3 font-weight-medium"
                >Forgot password?</router-link
              >
            </v-hover>
            <div class="text-center mt-8">
              <v-btn
                class="signin-btn rounded-lg font-weight-bold text-capitalize"
                type="submit"
                color="success"
                :disabled="!valid"
        ...
        <div class="bottom-section">
          <p class="center font-weight-bold">
            Don't have account yet?
            <router-link to="/get-started">Join BidOut</router-link>
          </p>
        </div>
      </v-col>
