        ...
        <div class="content-section fill-height">
          <v-row align="center" justify="space-between" class="px-6 mb-4 mt-2 mx-0">
            ...
            <v-col cols="6" class="text-right pr-0">
              <v-btn large elevation="0" color="#0D9648" height="56px" @click="createTem"
                class="text-capitalize white--text font-weight-bold py-6">Create New Template</v-btn>
            </v-col>
          </v-row>
                ...
                <v-dialog v-model="dialog" width="500">
                  <v-card>
                    ...
                    <v-card-actions>
                      ...
                      <v-btn color="#0d9648" outlined @click="deleteTemp(); dialog = false">
                        Confirm
                      </v-btn>
                    </v-card-actions>
                  </v-card>
